...
class ChaitanyaAppointmentService(models.Model):
    ...
    product_id = fields.Many2one(
        "product.product",
        string="Checkout Product",
        copy=False,
        help="Auto-created Odoo service product used by website_sale checkout.",
    )
    ...
    def write(self, vals):
        ...
        sync_fields = {"name", "price", "image", "website_published", "active", "product_id"}
